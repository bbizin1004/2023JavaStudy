...
-이름이 없는 클래스를 말한다.
-내부클래스처럼 이벤트 기반으 프로그래밍에서 많이 사용된다.
...
class Singer {
	...
	/*Object클래스에 정의된 메서드로 인스턴스가 가진 값을 문자열로
	 반환해주는 메서드이다. Java에서 정의하는 모든 클래스는 Object 클래스를
	 상속하므로 이와같이 오버라이딩이 가능하다.*/
	@Override
...
public class E02AnonymousClass {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 생성해서 그 주소값을 할당한다.
		 개념적으로 new GirlGroup(){}; => 익명 extends GirlGroup과
		 같다. 이름이 없는 인스턴스 이므로 부모클래스의 이름을 빌려서
		...
		/*인터페이스를 부모로 사용하여 구현한 후 오버라이딩 하여 기능을 재정의한 후
		  사용한다. */
