...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		/*
		 * parseInt() : 숫자형식의 문자열을 정수(숫자)로 변경한다. ParseDouble() : 실수로 변경한다.
		 */
		...
		/*
		 * 문자열을 숫자로 변경할때는 반드시 숫자형식만 기술해야한다. "원"은 숫자가 아니므로 예외가 발생한다.
		 */
		String money = "120원";
		...
		/*
		 * 실수형태의 문자열을 숫자로 변경할때는 parseInt()를 사용할 수 없다. 앞과 동일한 예외가 발생한다.
		 */
		 ...
		 */
		System.out.println("inDigit()를 통한 숫자판단");
		...
		/*
		 * isLetter() : 문자인지 판단하는 메서드로 특수기호나 숫자형일때 false를 반환한다.
		 */
		...
		/*
		 * isLowerCase() :소문자인지 판단. isUpperCase() :대문자인지 판단. 단 영문이 아닌 경우 무조건 false를
		 * 반환한다.
		 */
		...
		/*
		 * 시나리오] 주어진 문자열안에 몇개의 공백문자(스페이스)가 있는지 판단하는 프로그램을 작성하시오. 참고) toCharArray() :
