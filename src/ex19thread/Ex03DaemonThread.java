...
: 메인쓰레드와 Working쓰레드 (개발자가 정의한 쓰레드)를 일겉는 것으로
메인쓰레드가 종료되어도 계속 실행되며, Dead 상태가 되어야만 실행이 졸료되는
...
public class Ex03DaemonThread {
	...
	public static void main(String[] args) {
		...
		/*
		첫번째 독깁쓰레드 생성 미 시작. 우선순위를 별도로 부여하지
		...
		/*
		 데몬쓰레드는 독립쓰레드를 먼저 생상한 후 setDaemon()을 통해
		 만들 수 있다.
		 */
