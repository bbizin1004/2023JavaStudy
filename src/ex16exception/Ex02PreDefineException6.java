...
public class Ex02PreDefineException6 {
	 /*
	  ...
	  전혀 없는 상태이므로 이 상태에서는 형변환을 할수없어 예외가 발생한다.
	  */
	public static void main(String[] args)  {	
  
		Object object = new Object();
		try {
			//순수한 Object객체이므로 자식 타입으로 형병환 할수없다.
	...
	되므로 여기에서 상속관계가 확인된다. 매개변수 o는 원래 String타입이엇으므로
	instanceof를 통해 String임을 확인할수 있고 이경우에는
	다운캐스팅이 가능하게된다.
	 */
