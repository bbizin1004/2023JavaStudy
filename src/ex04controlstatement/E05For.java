...
public class E05For {
	 ...
	 */
		...
		System.out.println("1~10사이 2의 배수의합(방법1):"+total);
		
		/*
		 방법2] if문 없이 초기밧을 0부터 시작해서 2씩 증가시킨다.
		 */
       ...
       /*
       for문으 끝에 ;을 사용하면 반복할 문장이 없는것으로 간주되어 
       for문과 상관없이 한번만 실행된다. 	 
        */
		...
		/*
		 ...
		 Variable)이라고 한다. 지역변수는 해당 지역(블럭)을 벗어나면
		 메모리에서 소멸되는 특징을 가지고 있다.
		 */
		...
		/*
		 ...
		 해당변수는 for문으 안쪽(좁은지역)에서 사용할 수 있다.
