...
public class DeChild extends DeParent {
	...
	public  DeChild(String name, int age, String stNumber) {
		//자식은 부모의 생성자 호출을 통해 먼저 부모인스턴스를 생성한후 
		//자신의 인스턴스를 생성해야한다.
		super(name,age);
	...
	/*
	 오버라이딩 아님 : 부모클래스에서 private 멤버로 선언하였으므로
	...
	/*
	 ...
	 -부모에서 default로 선언하면 자식에서는 default 혹은 그보다 넓은 
	  public 으로 선언하면 오버라이딩이 간하다.
	 */
	@Override
	public String sleep() {
	...
	/*
	 메서드 형태가 부모쪽과는 다르므로 오버라이딩이 될수 없다.
