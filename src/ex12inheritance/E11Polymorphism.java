...
public class E11Polymorphism {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 Object의 참조변수로 참조가 가능하다. 또한  object클래스에 정의된 모든 메서드를
		 별도의 선언없이 사용할 수 있고, 필요하다면 오버라이딩도 할수있다.
		 */
