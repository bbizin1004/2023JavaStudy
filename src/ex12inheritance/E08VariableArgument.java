...
//	}
	...
	/*
	 ...을 통해 매개변수 param이 2개이상의 인수를 받을 수 있는것을 명시한다.
	...
	public static void main(String[] args) {
		System.out.println("getToatal(args1)호출:"+
				getTotal(10));
		System.out.println("getToatal(args1,args2)호출:"+
				getTotal(10,20));
		System.out.println("getToatal(args1,args2,args3)호출:"+
				getTotal(10,20,30));
		System.out.println("getToatal(매개변수6개)호출:"+
