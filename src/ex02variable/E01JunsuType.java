...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		/*
		 ...
		 -즉 정수형 변수를 사용할때에는 거의 대부븐 int형을 사용하면 된다.
		 */
		...
		/*
		 100/200의 결과는 0이 나오게 된다. Java에서는 정수와 정수의 연산결과로 정수가 반환된다.
		  만약 실수의 겨로가를 반환받고 싶다면 형변환(Type casting)를 해야한다.
		 */
		result1=int1/int2;
		System.out.println("int1/int/2="+result1);
		...
		/*
		 자바 컴파일러는 정수형 상수를 기본적으로 int형으로 간주하기때문에 아래 정수를 메모리에 
		 로드하는 순간 에러가 발생한다.
		 이때 점미사(L 혹은 l)을 붙여서 int형의 자료가 아닌 long형의 자료임을 컴파일러에게 
		 아렬줘야 한다. 이와같이 할당을 위한 입력되는 숫자도 자료형을 기반으로 메모리에 로드되는데 
