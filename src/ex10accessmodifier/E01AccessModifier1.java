...
/* class를 정의할때는 반드시 puvlic이나 default(생략형)만 사용할 수 있다.
...
/* public 클래스는 해당 Java 파일을 대표하는 클래스로 파일명과 동일해야
 한다. 또한 public 클래스는 자바 파일 하나당 딱 한개만 정의할수 있다.
 public을 지정하는 경우 다른 패키지에서도 접근을 허용하게되므로 하나의
...
public class E01AccessModifier1 {
	...
	private void privateMethod() {
		/*동일 클래스 내에서는 private 멤버라 할지라도 접근을
		 허용한다. 즉 동일 클래스 내에서는 집근지정자의 영향을 받지 
		 않는다.*/
		privateVar =100;
