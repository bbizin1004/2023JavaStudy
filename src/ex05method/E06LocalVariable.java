...
/*
지역변수(Local variable)
-변수는 사용범위(Scope)를 가지고 있고, 해당 지역내에서만 사용할수 있다.
...
public class E06LocalVariable {
	...
	public static void main(String[] args) {
		...
		if(scope) {
			...
			int num=5;
			System.out.println("첳ㅅ번째 if문의 esle지역"+num);
		}
		/*
	...
	/*main에서 선언한 변수 num은 메모리에 아직 상주하고 있지만 해당
	 메서드는 크기가 동일한 서로 다른 지역에 저의되었으므로 같은 이름의
	 변수를 선언할 수 있다.
	 앞의 main메서드의 if~else문의 블럭도 같은 개녑으로 변수를 선언한
	 것이다.  */
