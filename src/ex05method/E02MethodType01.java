...
즉 어떤 하나의 업무를 처리하기 위한 모듈(부속품)이라 정의할수 있다.
규칙
-메서드는 반드시 class 내부에 정의해야한다.
-메서드 내부에 또 다른 메서드를 정으할수없다. 이런경우 에러가 발생한다.
...
//		return;
		...
		if(retunrValue%2==0) {
			System.out.println(retunrValue +"는 짝수");
			//함수에서 return은 종료를 의미한다.
			return;
		}
		
		
		System.out.println(retunrValue + "는 홀수");
